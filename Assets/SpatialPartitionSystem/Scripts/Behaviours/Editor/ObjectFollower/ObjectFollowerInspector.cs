...
public class ObjectFollowerInspector : Editor
{
    ...
    {
        VisualTreeAsset uiAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/SpatialPartitionSystem/Scripts/Behaviours/Editor/ObjectFollower/ObjectFollowerInspector.uxml");
