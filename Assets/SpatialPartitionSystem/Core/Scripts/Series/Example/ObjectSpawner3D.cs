...
namespace SpatialPartitionSystem.Core.Series
{
    ...
    public class ObjectSpawner3D : MonoBehaviour
    {
        ...
        [SerializeField] private Bounds3DObject objectPrefab;
        [Tooltip("The parent container for the created objects.")]
        [SerializeField] private Transform objectsContainer;
        
        [Space]
        [SerializeField] UnityEvent<Bounds3DObject> onObjectCreated = new UnityEvent<Bounds3DObject>();
        
        private readonly List<Bounds3DObject> _objects = new List<Bounds3DObject>(capacity: 100);
        ...
        {
            Bounds3DObject rootSpatialObject = GetComponent<Bounds3DObject>();
