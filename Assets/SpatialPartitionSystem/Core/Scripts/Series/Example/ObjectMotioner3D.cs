...
namespace SpatialPartitionSystem.Core.Series
{
    ...
    public class ObjectMotioner3D : MonoBehaviour
    {
        ...
        [Space]
        [SerializeField] private UnityEvent<Bounds3DObject> onObjectUpdated = new UnityEvent<Bounds3DObject>();
        [SerializeField] private UnityEvent onAllObjectsUpdated = new UnityEvent();
        
        private Bounds3DObject _rootSpatialObject;
        ...
        private class MobileObject
        {
            ...
            public Bounds3DObject target;
        }
        
        private void Awake()
        {
            _rootSpatialObject = GetComponent<Bounds3DObject>();
        }
        ...
        public void AddMobileObject(Bounds3DObject obj)
        {
